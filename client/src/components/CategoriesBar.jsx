...
const CategoriesBar = () => (
  <div className="hidden md:flex bg-[#EFE3DA]/70 border-b border-[#DCC8BC]/70 px-10">
    <div className="max-w-screen-xl mx-auto w-full flex items-center gap-1">
      <button className="flex items-center gap-2.5 bg-[#8B776E] text-white text-xs font-semibold px-6 py-4 hover:bg-[#6E5B54] transition-colors tracking-wider flex-shrink-0">
